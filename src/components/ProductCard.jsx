            ...
            <div className="p-4">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="flex flex-1 items-center justify-center gap-2  rounded-md bg-indigo-600 p-2 text-sm font-semibold text-white transition hover:bg-indigo-500 shadow-sm hover:shadow-indigo-900/50 sm:flex-none sm:text-base"
                    >
